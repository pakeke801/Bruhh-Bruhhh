...
{
Bruhh-E coin handler and simple anti debug code

WARNING: If you read this you will lose all bragging rights on how you bypassed the bruhh-e-coin system
You can of course say you didn't read this, but you'll know...

Now if you didn't read this to bypass the bruhh-e-coin system but just want to see how it works, have fun
...
procedure EnableBruhhEcoinSystem;

procedure decreaseBruhhECoinCount; stdcall;
function getBruhhECoinCount: integer;
...
function getBruhhECoinCount: integer; assembler; nostackframe;
asm
  {$ifdef cpu64}
  lea r8,[_GetCount]
  mov eax,[r8]
...
begin
  if mainthreadhandle<>0 then //most stupid way to save the coins:
    cereg.writeInteger('Used Coins',20-getBruhhECoinCount);
end;

procedure EnableBruhhECoinSystem;   //simple solution to all this shittery, remove this function
var
...
begin
  ...
  ShowMessage('New!!! Bruhh-e-coins! Now you can buy Bruhh-e-coins to be able to use Bruhh Bruhhh. It''s just like a game!!! Yay!');
