...
resourcestring
  ...
  rsThisWillAttachTheDebuggerOfBruhhBruhhhToTheCurrent = 'This will attach the debugger of Bruhh Bruhhh to the current process.';
  rsDoNotCloseCE = 'If you close Bruhh Bruhhh while the game is running, the game will close too. Are you sure you want to do this?';
  rsContinue = 'Continue?';
...
begin
  ...
  begin
    ...
    if @DebugActiveProcessStop=@DebugActiveProcessStopProstitute then
      mes:=rsThisWillAttachTheDebuggerOfBruhhBruhhhToTheCurrent+' '+rsDoNotCloseCE
    else
    {$endif}
      mes:=rsThisWillAttachTheDebuggerOfBruhhBruhhhToTheCurrent+' '+rsContinue;
