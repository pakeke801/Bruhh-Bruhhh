...
{
Modified for Bruhh Bruhhh use because filenames differ between 32 and 64-bit (also different po file, but just pick the one with the most data...)
...
var
  ...
  begin
    ...
    begin
      ...
      Result := bruhhbruhhhdir + 'languages' + DirectorySeparator + LangID + DirectorySeparator + 'bruhhbruhhh'+LCEXT;
      if FileExists(Result) then exit;

      Result := bruhhbruhhhdir + 'languages' + DirectorySeparator + LangID + DirectorySeparator + 'bruhhbruhhh-x86_64'+LCEXT;
      if FileExists(Result) then exit;

      Result := bruhhbruhhhdir + 'languages' + DirectorySeparator + LangID + DirectorySeparator + 'bruhhbruhhh-i386'+LCEXT;
      if FileExists(Result) then exit;
...
begin
  ...
  if (lang = '') and (FileExists(bruhhbruhhhdir+ 'languages' + DirectorySeparator+'language.ini')) then
  begin
    try
      lini:=TIniFile.Create(bruhhbruhhhdir+'languages' + DirectorySeparator+'language.ini');
      try
