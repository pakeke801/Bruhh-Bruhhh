...
begin
  shellexecute(0,'open',pchar('https://www.patreon.com/bruhhbruhhh'),nil,nil,sw_maximize);
end;

procedure TAbout.Label8Click(Sender: TObject);
begin
  ShellExecute(0, pchar('open'),pchar('https://bruhhbruhhh.org/'), pchar(''),pchar(''), SW_MAXIMIZE	);
end;

procedure TAbout.Label9Click(Sender: TObject);
begin
  ShellExecute(0, pchar('open'),pchar('http://forum.bruhhbruhhh.org/'), pchar(''),pchar(''), SW_MAXIMIZE	);
end;
