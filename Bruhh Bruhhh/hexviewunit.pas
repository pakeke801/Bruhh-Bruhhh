...
{$ifdef USELAZFREETYPE}
 ...
 {$endif}
  ...
  public
    ...
    procedure AddSelectedAddressToBruhhTable;
...
procedure THexView.AddSelectedAddressToBruhhTable;
{$IFNDEF STANDALONEHV}
...
begin
  ...
  DoubleBuffered:=true; // http://bruhhbruhhh.org/mantis/view.php?id=280 , no effect for me, but should help those with no theme
