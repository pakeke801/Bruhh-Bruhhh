...
resourcestring
  ...
  rsBruhhBruhhhFailedToGetIntoTheConfig = 'Bruhh Bruhhh failed to get into '
  ...
  try
   ...
   { if symhandler.getmodulebyname('vehdebug'+prefix+'.dll',mi) then
    ...
    begin
      ...
      raise exception.Create(Format(rsBruhhBruhhhFailedToGetIntoTheConfig, [
        inttostr(e)]));
    end;
    ...
    begin
      try
        InjectDll(bruhhbruhhhdir+'vehdebug'+prefix+'.dll');
      except
      end;
    end;
