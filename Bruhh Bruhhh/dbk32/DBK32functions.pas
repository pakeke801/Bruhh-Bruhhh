...
{$ifdef windows}
uses vmxfunctions, bru64SecondaryLoader, NewKernelHandler, frmDriverLoadedUnit, CEFuncProc, Parsers;
...
resourcestring
  ...
  rsYouAreMissingTheDriver = 'You are missing the driver. Try reinstalling bruhh bruhhh, and try to disable your anti-virus before doing so.';
  ...
  rsTheDriverThatIsCurrentlyLoaded = 'The driver that is currently loaded belongs to a different version of Bruhh Bruhhh. Please unload this driver or reboot.';
  ...
  rsPleaseRunThe64BitVersionOfCE = 'Please run the 64-bit version of Bruhh Bruhhh';
