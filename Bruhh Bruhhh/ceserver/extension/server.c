...
/*
  __android_log_print(ANDROID_LOG_DEBUG, "BRUHHENGING", "Hello \n");

  __android_log_print(ANDROID_LOG_DEBUG, "BRUHHENGING", "module1=%p\n", module);

  module=dlopen("libdvm.so", module);
  __android_log_print(ANDROID_LOG_DEBUG, "BRUHHENGING", "module=%p\n", module);


  X=dlsym(module, "dvmJitStats");
  __android_log_print(ANDROID_LOG_DEBUG, "BRUHHENGING", "After dlsym\n");

  __android_log_print(ANDROID_LOG_DEBUG, "BRUHHENGING", "X=%p\n", X);
