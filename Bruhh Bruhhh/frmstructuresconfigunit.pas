...
begin
  ...
  try
    ...
    if Reg.OpenKey('\Software\Bruhh Bruhhh\DissectData',true) then
    begin
      ...
      if customfont then
      begin
        if Reg.OpenKey('\Software\Bruhh Bruhhh\DissectData\Font',true) then
...
begin
  ...
  try
    ...
    begin
      ...
      if Reg.OpenKey('\Software\Bruhh Bruhhh\DissectData\Font',false) then
      begin
