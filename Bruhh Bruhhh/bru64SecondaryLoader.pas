...
resourcestring
  ...
  rsModuleLoaderDailedToMbru64sysToMemoryap = 'ModuleLoader failed to map bru64.sys to memory';
...
begin
  ...
  try
   ...
   // ShowMessage('Part 1');
    ...
    ml:=TModuleLoader.create(BruhhBruhhhDir+'bru64.sys');
   ...
   // ShowMessage('Part 3');
    ...
    begin
      ...
      showmessage(rsModuleLoaderDailedToMbru64sysToMemoryap);
