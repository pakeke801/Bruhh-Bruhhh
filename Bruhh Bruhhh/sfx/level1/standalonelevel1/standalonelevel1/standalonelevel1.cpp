			...
			if (i)
			{
			 ...
			 // STATUS=0x80070002;
			  if (!FAILED(STATUS))
			  {
				  ...
				  if (!correctversion)
				  {
					  MessageBoxA(0,"Please update your Bruhh Bruhhh version to Bruhh Bruhhh 6.3 or later\n", "Launch Error",MB_OK | MB_ICONERROR);
				  }
				  else
				  {
					  //launch it
					  ...
					  {						  
						  //Because Bruhh Bruhhh deletes files with name CET_TRAINER.CETRAINER it can be used to determine when ce is finished with it			  
			  ...
			  else
			  {
				  ...
				  else
				  {
					  ...
					  sprintf_s(errorstring, 254,"Your system must have Bruhh Bruhhh installed to be able to use this trainer\nwww.bruhhbruhhh.org\n(%x)", STATUS);
