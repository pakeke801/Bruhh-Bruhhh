...
Fixes:
  ...
  LuaBruhhh: Autocomplete won't lowercase functions anymore if they are lua functions
...
lua:
  changes:
    ...
    TfrmLuaBruhhh: document the mOutput and mScript properties
...
How to use:
There's a tutorial program included with Bruhh Bruhhh,
it teaches how to use the basics of Bruhh Bruhhh, also the helpfile may be of use.
...
For more information about Bruhh Bruhhh or tables for it 
and other things, goto this url:
http://www.bruhhbruhhh.org/
