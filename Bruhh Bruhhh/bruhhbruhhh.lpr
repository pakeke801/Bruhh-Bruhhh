...
uses
  ...
  LuaHandler, frmLuaBruhhhUnit, frmMemviewPreferencesUnit,
  ...
  LuaDebug, frmUltimapUnit, bru64SecondaryLoader, frmHotkeyExUnit,
  ...
  LuaBruhhComponent, LuaAddresslist, frmDriverLoadedUnit, memdisplay,
  ...
  LuaHeaderSections, frmDebuggerAttachTimeoutUnit, bruhhecoins,
...
var
  ...
  noautorun: boolean;
begin
  Application.Title:='Bruhh Bruhhh 7.2';
  {$ifdef darwin}
  macPortFixRegPath;
  {$endif}
  ...
  begin
    ...
    if r.OpenKey('\Software\Bruhh Bruhhh',false) then
    begin
