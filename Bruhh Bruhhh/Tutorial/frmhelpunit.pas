...
begin
  {$ifdef windows}
  ShellExecute(0, PChar('open'), PChar('https://bruhhbruhhh.org/tutorial.php?tutorial='+ftutorialtag),PChar(''), PChar(''), SW_SHOW);
  {$else}
  OpenURL('https://bruhhbruhhh.org/tutorial.php?tutorial='+ftutorialtag);
  {$endif}
end;
