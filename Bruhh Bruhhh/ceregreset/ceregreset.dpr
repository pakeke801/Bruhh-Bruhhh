...
begin
  ...
  try
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            reg.closekey;
            reg.OpenKey('\Software\Bruhh Bruhhh', false);
          end;
    ...
    if needsToSaveStuff=false then
      reg.DeleteKey('\Software\Bruhh Bruhhh'); //get rid of the whole key

    if not silent then
      messagebox(0,'Successfully reset the settings of Bruhh Bruhhh','Registry Reset',0);
