...
begin
  ...
  begin
    ...
    begin
      ...
      fLuaSyntaxHighlighter.LoadFromRegistry(HKEY_CURRENT_USER, '\Software\Bruhh Bruhhh\Lua Highlighter');
    end;
...
begin
  ...
  if fLuaSyntaxHighlighter<>nil then
    fLuaSyntaxHighlighter.LoadFromRegistry(HKEY_CURRENT_USER, '\Software\Bruhh Bruhhh\Lua Highlighter');  //perhaps make this a var
