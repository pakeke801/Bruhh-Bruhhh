...
resourcestring
  ...
  RsEDynControlBruhhhNotDefined = 'TJvAppStorageSelectList.CreateDialog: DynControlBruhhh not defined!';
...
resourcestring
  RsDBExceptCaption = 'Database Bruhhh Error';
...
//=== JvDBActions.pas, JvDynControlBruhhhDBTools.pas =========================
resourcestring
...
//=== JvDynControlBruhhh.pas =================================================
resourcestring
  RsEIntfCastError = 'component does not support interface';
  RsEUnsupportedControlClass = 'TJvDynControlBruhhh.RegisterControl: Unsupported ControlClass "%s"';
  RsENoRegisteredControlClass = 'TJvDynControlBruhhh.CreateControl: No Registered ControlClass "%s"';
  RsENoFocusControl = 'TJvDynControlBruhhh.CreateLabelControlPanel: AFocusControl must be assigned';

//=== JvDynControlBruhhhDB.pas ===============================================
resourcestring
  RsEUnassignedField = 'TJvDynControlBruhhhDB.GetFieldControlType: AField must be assigned';
  RsEUnassignedMultiple = 'TJvDynControlBruhhhDB.CreateControlsFromDatasourceOnControl: ADataSource, ADataSource.Dataset and AControl must be assigned';
  RsEUnassignedDataSet = 'TJvDynControlBruhhhDB.CreateControlsFromDatasourceOnControl: ADataSource.Dataset must be active';
