...
resourcestring
  ...
  rsThisIsQuiteABigStructureHowManyBytesDoYouWantToSav = 'This is quite a big '
   ...
   rsDoYouWantBruhhBruhhhToTryAndFillInTheMostBasicType = 'Do you want Bruhh '
     +'Bruhhh to try and fill in the most basic types of the struct using the '
     +'current address?';
   ...
   rsWrongVersion = 'This structure file was generated with a newer version of '
     +'Bruhh Bruhhh. (That means there''s more than likely a new version so '
     +'please update....)';
...
begin
  ...
  try
    ...
    if Reg.OpenKey('\Software\Bruhh Bruhhh\DissectData',false) then
    begin
...
begin
  ...
  begin
    ...
    autoFillIn:=messagedlg(rsDoYouWantBruhhBruhhhToTryAndFillInTheMostBasicType, mtconfirmation, [mbyes, mbno, mbcancel], 0);
