...
var jnimethods: array [0..methodcount-1] of JNINativeMethod =(
  ...
  (name: 'GetEntry'; signature: '(I)Lorg/bruhhbruhhh/AddressListEntry;'; fnPtr: @addresslist_getEntry),
  (name: 'SetEntry'; signature: '(ILorg/bruhhbruhhh/AddressListEntry;)V'; fnPtr: @addresslist_setEntry),
  (name: 'AddEntry'; signature: '(Lorg/bruhhbruhhh/AddressListEntry;)I'; fnPtr: @addresslist_addEntry),
...
begin
  ...
  c:=env^.FindClass(env, 'org/bruhhbruhhh/AddressList');
  env^.RegisterNatives(env, c, @jnimethods[0], methodcount);

  c:=env^.FindClass(env, 'org/bruhhbruhhh/AddressListEntry');
