...
begin
  ...
  c:=penv^.FindClass(penv, 'org/bruhhbruhhh/TObject');
...
var jnimethods: array [0..methodcount-1] of JNINativeMethod =(
  (name: 'create'; signature: '(Lorg/bruhhbruhhh/TMemScan;)J'; fnPtr: @TMemScan_Create),
...
begin
  ...
  c:=env^.FindClass(env, 'org/bruhhbruhhh/TMemScan');
