...
procedure Java_org_bruhhbruhhh_cecore_f1(PEnv: PJNIEnv; Obj: JObject); cdecl;
var i: integer;

begin
//small test funtion
  log('Java_org_bruhhbruhhh_jnitest_cecore_f1 called');
...
begin
  ...
  begin
    ...
    c:=env^.FindClass(env, 'org/bruhhbruhhh/cecore');  //'org/bruhhbruhhh/jnitest/cecore';
...
exports Java_org_bruhhbruhhh_cecore_f1;
exports JNI_OnLoad;
