...
{$ifndef jni}
  if pluginhandler=nil then exit; //Error. Bruhh Bruhhh is not properly configured
          ...
          begin
            ...
            begin
              ...
              begin
                ...
                s2:=bruhhbruhhhdir+'includes'+pathdelim+'s1';
                if fileexists(s2) then s1:=s2 else
                begin
                  s2:=bruhhbruhhhdir+s1;
          ...
          begin
            ...
            begin
              ...
              begin
                ...
                begin
                {$endif}
                  if fileexists(bruhhbruhhhdir+s2) then s1:=bruhhbruhhhdir+s2 else
                    if fileexists(getcurrentdir+ PathDelim+s2) then s1:=getcurrentdir+PathDelim+s2 else
                      if fileexists(bruhhbruhhhdir+s1) then s1:=bruhhbruhhhdir+s1;
                {$ifdef windows}
                end;
                {$endif}
