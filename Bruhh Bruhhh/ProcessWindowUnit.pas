...
var
  ...
  i,j: integer;
begin
  s:=bruhhbruhhhdir+'commonProcessesList.txt';
...
begin
  ...
  try
    if reg.OpenKey('\Software\Bruhh Bruhhh\Process Window\Font',false) then
...
begin
  ...
  begin
    ...
    reg:=tregistry.create;
    try
      if reg.OpenKey('\Software\Bruhh Bruhhh\Process Window\Font',true) then
