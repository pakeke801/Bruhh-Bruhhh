...
resourcestring
  ...
  rsUUPleaseRunThe64bitVersionOfBruhhBruhhhToMakeUseOfThisFeature = 'Please run the 64-bit version of Bruhh Bruhhh to make use of this feature';
...
begin
  ...
  {$ifdef cpu32}
  if Is64bitOS then raise exception.create(rsUUPleaseRunThe64bitVersionOfBruhhBruhhhToMakeUseOfThisFeature);
  {$endif}
