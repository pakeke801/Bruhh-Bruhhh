...
begin
  ...
  try
    ...
    symbolpath:=usedtempdir+'Bruhh Bruhhh Symbols'+pathdelim;
...
var
  ...
  i,j: integer;
begin
  s:=bruhhbruhhhdir+'commonmodulelist.txt';
...
{$ifdef windows}
{$ifdef cpu32}
  dbghlp:=LoadLibrary(pchar(BruhhBruhhhDir+'\win32\dbghelp.dll'));
{$else}
  dbghlp:=LoadLibrary(pchar(BruhhBruhhhDir+'\win64\dbghelp.dll'));
{$endif}
...
begin
  ...
  databasepath:=usedtempdir+'Bruhh Bruhhh Symbols'+pathdelim+'structures.sqlite';
end;
