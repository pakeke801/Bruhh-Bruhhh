// Copyright Bruhh Bruhhh. All Rights Reserved.
...
resourcestring
  ...
  rsMSTheScanWasForcedToTerminateSubsequentScansMayNotFunctionProperlyEtc = 'The scan was forced to terminate. Subsequent scans may not function properly. It''s recommended to restart Bruhh Bruhhh';
  rsThread = 'thread ';
//===============Local functions================//
...
begin
  ...
  fScanResultFolder:=usedtempdir+'Bruhh Bruhhh'+pathdelim;
 ...
 // OutputDebugString('TMemscan.DeleteScanfolder');
  ...
  begin
    try
      ...
      if FindFirst(usedtempdir+'Bruhh Bruhhh'+pathdelim+'{*}',  faDirectory , info)=0 then
      begin
        repeat
          ...
          begin
            ...
            begin
              ...
              f:=usedtempdir+'Bruhh Bruhhh'+pathdelim+info.name;
