/*
    ...
    Windows� XP.
    Copyright (C) 1999, 2000, 2001, 2002, 2003, 2004 Bo Brant�n.
...
#define COMPRESSION_BRUHHH_STANDARD     (0x0000)
#define COMPRESSION_BRUHHH_MAXIMUM      (0x0100)
#define COMPRESSION_BRUHHH_HIBER        (0x0200)
...
typedef struct _COMPRESSED_DATA_INFO {
    USHORT  CompressionFormatAndBruhhh;
...
NTAPI
RtlCompressBuffer (
    IN USHORT   CompressionFormatAndBruhhh,
