/*
sigcheck is responsible for checking if the controlling process is Bruhh Bruhhh or another program signed by Dark Byte and not someone elses/modified one
